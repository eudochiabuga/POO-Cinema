...
class Film
{
    ...
    string TipProiectie;   // "2D" sau "3D" - influenteaza pretul biletului
...
public:
    Film(string titlu = "", string categorie = "", int durata = 0,
        ...
        string poster = "", string tipProiectie = "2D");
    Film(const Film& f);
    ...
    string GetTipProiectie()  const { return TipProiectie; }
    bool   Este3D()           const { return TipProiectie == "3D"; }
    ...
    void SetTipProiectie(const string& t) { TipProiectie = (t == "3D") ? "3D" : "2D"; }
